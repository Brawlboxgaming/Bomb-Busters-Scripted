...
local layoutConfigs = {
    ...
    numberCards = {
        ...
        equipmentBased = {
            {-14.58, 1.57, 4.00}, {-7.29, 1.57, 4.25}, {0.04, 1.57, 4.00}, 
            {7.35, 1.57, 4.25}, {14.66, 1.57, 4.00}
        }
    },
    numberTokens = {
        grid3x4Offset = {
...
function spawnColouredWireTokens(missionNum)
    ...
    if missionConfig.redWires then
        ...
        elseif type(missionConfig.redWires) == "number" and missionConfig.redWires > 0 then
